...
<body>
    <img class="bg" src="bg.jpg" alt="ABESEC">
    <div class="container">
        <h1>Welcome to ABES Engineering College US Trip form</h1>
        <p>Enter your details and submit this form to confirm your
            participation in the trip </p>
            <?php
            if($insert == true){
                echo "<p class='submitmsg'>Thanks for submitting the form.We are happy to
            see you joining us for US trip</p>";
            }
            ?>
